    ...
    <>
      ...
      {mounted && (
        <div
          className={cn(
            styles.menu,
            'px-8 flex flex-col bg-gray-100 dark:bg-gray-900 fixed top-0 left-0',
        ...
        >
          ...
          <ul>
            ...
            <li
              ...
              onClick={toggleMenu}
            >
              <Link href="https://drive.google.com/file/d/1_cPE9smlQlsEmmS0M1-HuONFKNfSkNTg/view?usp=sharing">
