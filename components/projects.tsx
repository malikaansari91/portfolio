...
export default function Projects() {
  ...
  return (
    <div>
      <h2 className="text-4xl font-bold text-center mb-12 text-black dark:text-white">Development Endeavors</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project, index) => (
          <Card
            key={index}
            className="bg-gray-100/80 dark:bg-gray-900/60 border-gray-300 dark:border-gray-800 overflow-hidden hover:border-blue-500 transition-colors"
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4 h-24 overflow-hidden">{project.description}</p>
